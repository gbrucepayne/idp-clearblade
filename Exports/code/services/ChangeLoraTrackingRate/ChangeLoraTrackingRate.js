function ChangeLoraTrackingRate(req, resp){
    ...
    var _interval = req.params.interval_seconds || 120;
    var _lora_mac = req.params.lora_mac || "008000000000D89D";
    ...
    var messages = [
        {
            ...
            "Payload": {
                ...
                "Fields": [
                    ...
                    {
                        "Name": "lora_mac",
                        "Value": _lora_mac  // NEED TO CONVERT TO A BYTE ARRAYBUFFER THEN ENCODE AS BASE64
                    }
                ]
            }
        }
